      ...
      >
        <div>
          ...
          <input
            ...
            placeholder="Ej: 1.2"
            className="w-full rounded-lg border border-gray-300 px-3 py-3 text-base text-gray-800 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-200"
          />
        </div>
